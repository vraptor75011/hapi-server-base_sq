...
const FixedValidation = require('./region_validation_base');
...
const Validations = ModelValidation(DB.CntrRegion);
...
const RelationValidation = ModelRelationValidation(DB.CntrRegion, true, DB.CntrRegion.name, null);
...
module.exports = {
	...
	//FindOne
	oneParams: Joi.object().keys(_.assign({}, {regionId: paramId})),
	...
	//Relations URL
	//ADD_ONE
	addOneParams: Joi.object().keys(_.assign({}, {regionId: BaseValidation.paramId}, {childModel: relationList}, {childId: BaseValidation.paramId})),

	//REMOVE_ONE
	removeOneParams: Joi.object().keys(_.assign({}, {regionId: BaseValidation.paramId}, {childModel: relationList}, {childId: BaseValidation.paramId})),
	...
	//ADD_MANY
	addManyParams: Joi.object().keys(_.assign({}, {regionId: paramId}, {childModel: relationList})),
	addManyPayload: Joi.object().keys(_.assign({}, postRelation, BaseValidation.ids)),

	//REMOVE_MANY
	removeManyParams: Joi.object().keys(_.assign({}, {regionId: paramId}, {childModel: relationList})),
	...
	//GET_ALL
	getAllParams: Joi.object().keys(_.assign({}, {regionId: paramId}, {childModel: relationList})),
