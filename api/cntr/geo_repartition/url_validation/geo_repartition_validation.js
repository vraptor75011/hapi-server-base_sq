...
const FixedValidation = require('./geo_repartition_validation_base');
...
const Validations = ModelValidation(DB.CntrGeoRepartition);
...
const RelationValidation = ModelRelationValidation(DB.CntrGeoRepartition, true, DB.CntrGeoRepartition.name, null);
...
module.exports = {
	...
	//FindOne
	oneParams: Joi.object().keys(_.assign({}, {geoRepartitionId: paramId})),
	...
	//Relations URL
	//ADD_ONE
	addOneParams: Joi.object().keys(_.assign({}, {geoRepartitionId: BaseValidation.paramId}, {childModel: relationList}, {childId: BaseValidation.paramId})),

	//REMOVE_ONE
	removeOneParams: Joi.object().keys(_.assign({}, {geoRepartitionId: BaseValidation.paramId}, {childModel: relationList}, {childId: BaseValidation.paramId})),
	...
	//ADD_MANY
	addManyParams: Joi.object().keys(_.assign({}, {geoRepartitionId: paramId}, {childModel: relationList})),
	addManyPayload: Joi.object().keys(_.assign({}, postRelation, BaseValidation.ids)),

	//REMOVE_MANY
	removeManyParams: Joi.object().keys(_.assign({}, {geoRepartitionId: paramId}, {childModel: relationList})),
	...
	//GET_ALL
	getAllParams: Joi.object().keys(_.assign({}, {geoRepartitionId: paramId}, {childModel: relationList})),
